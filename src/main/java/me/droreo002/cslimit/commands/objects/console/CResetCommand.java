...
public class CResetCommand extends CSLCommand {
    
    public CResetCommand() {
        super("reset");
        setConsoleOnly(true);
    }
...
//                    sender.sendMessage(main.getLangManager().getMessage(MessageType.SHOP_CREATED_RESET, off));
//                    return;
//                } else {
...
//            target.sendMessage(main.getLangManager().getMessageConsole(MessageType.SHOP_CREATED_RESET_OTHER));
//        } else {
