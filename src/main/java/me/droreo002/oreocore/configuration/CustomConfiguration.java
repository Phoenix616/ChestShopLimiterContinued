    ...
    public void setupConfig() {
        ...
        if (!yamlFile.exists()) {
            try {
                ...
                plugin.getLogger().log(Level.SEVERE, "Failed to create custom config file! (" + getFilePath() + ")", e);
                return;
            }
        }
    ...
    public void saveConfig(boolean updateMemory) {
        if (updateMemory) {
            ...
            try {
                ...
                plugin.getLogger().log(Level.SEVERE, "Failed to save custom config file! (" + getFilePath() + ")", e);
            }
        }
    }
