...
public class ItemStackBuilder implements SerializableConfigVariable, Cloneable {
    ...
    public static final ItemStack GRAY_GLASS_PANE = ItemStackBuilder.of(Material.GRAY_STAINED_GLASS_PANE).getItemStack();
     ...
     * @return ItemStackBuilder
     */
    public ItemStackBuilder applyBuilderCondition(String conditionName, boolean conditionValue, @Nullable Runnable onConditionApplied) {
    ...
    public static ItemStackBuilder deserialize(ConfigurationSection section) {
        ...
        if (mat == null) throw new NullPointerException("Cannot find material with the ID of " + material);
        if (mat.isAir()) return ItemStackBuilder.of(mat);
